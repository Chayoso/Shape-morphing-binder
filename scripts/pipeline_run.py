...
def main():
    ...
    ap.add_argument("--rest_commit", action="store_true",
                    help="start every window from rest: v and C zeroed at each accepted commit (config.rest_commit; "
                         "docs/method.md 10.21)")
