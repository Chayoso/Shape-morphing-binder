...
ap.add_argument("--blur", type=float, default=1.5, help="Gaussian sigma in particle spacings")
...
_fr, _tg, _sr, _orient = orient_archive(z, a.npz)              # y-up (assets/orientation.json)
